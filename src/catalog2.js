...
export const CATALOG_RESELLER = {
  ...
  sku_7: { pid: '49', row: 'BR MOD FF PC VERSION', name: 'BR PC BYPASS 1 DAY', duration: '1 Day Pc Bypass + Silent', price: 175, image: 'https://i.postimg.cc/65Fdfcgp/Screenshot-20260425-150006.jpg', external: true },
  sku_8: { pid: '49', row: 'BR MOD FF PC VERSION', name: 'BR PC MODMENU 1 DAY', duration: '1 Day Pc Modmenu x86', price: 140, image: 'https://i.postimg.cc/65Fdfcgp/Screenshot-20260425-150006.jpg', external: true },
  sku_9: { pid: '49', row: 'BR MOD FF PC VERSION', name: 'BR PC MODMENU 10 DAY', duration: '10 Day Pc Modmenu x86', price: 455, image: 'https://i.postimg.cc/65Fdfcgp/Screenshot-20260425-150006.jpg', external: true },
  sku_10: { pid: '49', row: 'BR MOD FF PC VERSION', name: 'BR PC AIM SILENT 10 DAY', duration: '10 Days Pc Aim Silent', price: 455, image: 'https://i.postimg.cc/65Fdfcgp/Screenshot-20260425-150006.jpg', external: true },
  sku_11: { pid: '49', row: 'BR MOD FF PC VERSION', name: 'BR PC BYPASS 10 DAY', duration: '10 Days Pc Bypass + Silent', price: 525, image: 'https://i.postimg.cc/65Fdfcgp/Screenshot-20260425-150006.jpg', external: true },
  sku_12: { pid: '49', row: 'BR MOD FF PC VERSION', name: 'BR PC MODMENU 30 DAY', duration: '30 Day Pc Modmenu x86', price: 945, image: 'https://i.postimg.cc/65Fdfcgp/Screenshot-20260425-150006.jpg', external: true },
  ...
  sku_17: { pid: '67', row: 'BR MOD FF ROOT ANDROID', name: 'BR ROOT 30 DAY', duration: '30 DaYs', price: 875, image: 'https://i.postimg.cc/65Fdfcgp/Screenshot-20260425-150006.jpg', external: true },
  ...
  sku_23: { pid: '62', row: 'DRIP CLIENT FF GLOBAL', name: 'DRIP NONROOT 15 DAY', duration: '15 DaYS NONROOT', price: 455, image: 'https://i.postimg.cc/Jnwh1T2q/Screenshot-20260421-102516.jpg', external: true },
  sku_24: { pid: '62', row: 'DRIP CLIENT FF GLOBAL', name: 'DRIP NONROOT 3 DAY', duration: '3 DaYS NONROOT', price: 154, image: 'https://i.postimg.cc/Jnwh1T2q/Screenshot-20260421-102516.jpg', external: true },
  ...
  sku_32: { pid: '91', row: 'DRIP GLOBAL PROXY FF', name: 'DRIP PROXY 3 DAY', duration: '3 DaYs', price: 154, image: 'https://i.postimg.cc/Jnwh1T2q/Screenshot-20260421-102516.jpg', external: true },
  sku_33: { pid: '91', row: 'DRIP GLOBAL PROXY FF', name: 'DRIP PROXY 30 DAY', duration: '30 DaYs', price: 644, image: 'https://i.postimg.cc/Jnwh1T2q/Screenshot-20260421-102516.jpg', external: true },
  sku_34: { pid: '91', row: 'DRIP GLOBAL PROXY FF', name: 'DRIP PROXY 7 DAY', duration: '7 DaYs', price: 315, image: 'https://i.postimg.cc/Jnwh1T2q/Screenshot-20260421-102516.jpg', external: true },

  // ---- FLUORITE IOS FF (pid 58) ----
  sku_35: { pid: '58', row: 'FLUORITE IOS FF', name: 'FLUORITE FF 1 DAY', duration: '1 DAYs FluoRite FF', price: 385, image: 'https://i.postimg.cc/R07kHX0k/fluorite-ios-ff-og-1765886845.webp', external: true },
  sku_36: { pid: '58', row: 'FLUORITE IOS FF', name: 'FLUORITE FF 30 DAY', duration: '30 DAYs FluoRite FF', price: 2240, image: 'https://i.postimg.cc/R07kHX0k/fluorite-ios-ff-og-1765886845.webp', external: true },
  ...
  sku_42: { pid: '64', row: 'HAXX-CKER PRO FF ROOT ANDROID', name: 'HAXX-CKER 20 DAY', duration: '20 DaYs', price: 1120, image: 'https://i.postimg.cc/HLxmsSCy/Screenshot-20260425-150832.jpg', external: true },

  // ---- HG CHEATS ANDROID PROXY FF NONROOT (pid 123) ----
  sku_43: { pid: '123', row: 'HG CHEATS ANDROID PROXY FF NONROOT', name: 'HG PROXY 1 DAY', duration: '1 DaYs', price: 91, image: 'https://i.postimg.cc/fRGsXVfy/Screenshot-20260421-102611.jpg', external: true },
  sku_44: { pid: '123', row: 'HG CHEATS ANDROID PROXY FF NONROOT', name: 'HG PROXY 10 DAY', duration: '10 DaYs', price: 315, image: 'https://i.postimg.cc/fRGsXVfy/Screenshot-20260421-102611.jpg', external: true },
  sku_45: { pid: '123', row: 'HG CHEATS ANDROID PROXY FF NONROOT', name: 'HG PROXY 30 DAY', duration: '30 DaYs', price: 525, image: 'https://i.postimg.cc/fRGsXVfy/Screenshot-20260421-102611.jpg', external: true },
  sku_46: { pid: '123', row: 'HG CHEATS ANDROID PROXY FF NONROOT', name: 'HG PROXY 7 DAY', duration: '7 DaYs', price: 245, image: 'https://i.postimg.cc/fRGsXVfy/Screenshot-20260421-102611.jpg', external: true },

  // ---- HG CHEATS FF APKMOD NONROOT+ROOT (pid 65) ----
  sku_47: { pid: '65', row: 'HG CHEATS FF APKMOD NONROOT+ROOT', name: 'HG APKMOD 1 DAY', duration: '1 DaYs Root + Nonroot', price: 91, image: 'https://i.postimg.cc/fRGsXVfy/Screenshot-20260421-102611.jpg', external: true },
  sku_48: { pid: '65', row: 'HG CHEATS FF APKMOD NONROOT+ROOT', name: 'HG APKMOD 10 DAY', duration: '10 DaYs Root+Nonroot', price: 315, image: 'https://i.postimg.cc/fRGsXVfy/Screenshot-20260421-102611.jpg', external: true },
  sku_49: { pid: '65', row: 'HG CHEATS FF APKMOD NONROOT+ROOT', name: 'HG APKMOD 30 DAY', duration: '30 DaYs Root+Nonroot', price: 525, image: 'https://i.postimg.cc/fRGsXVfy/Screenshot-20260421-102611.jpg', external: true },
  sku_50: { pid: '65', row: 'HG CHEATS FF APKMOD NONROOT+ROOT', name: 'HG APKMOD 7 DAY', duration: '7 DaYs Root+Nonroot', price: 245, image: 'https://i.postimg.cc/fRGsXVfy/Screenshot-20260421-102611.jpg', external: true },

  // ---- HIKARI MOD FF ROOT ANDROID (pid 72) ----
  sku_51: { pid: '72', row: 'HIKARI MOD FF ROOT ANDROID', name: 'HIKARI 1 DAY', duration: '1 Days', price: 84, image: 'https://i.postimg.cc/k5kH3wM4/Screenshot-20260605-083930.jpg', external: true },
  sku_52: { pid: '72', row: 'HIKARI MOD FF ROOT ANDROID', name: 'HIKARI 15 DAY', duration: '15 Days', price: 350, image: 'https://i.postimg.cc/k5kH3wM4/Screenshot-20260605-083930.jpg', external: true },
  sku_53: { pid: '72', row: 'HIKARI MOD FF ROOT ANDROID', name: 'HIKARI 3 DAY', duration: '3 Days', price: 140, image: 'https://i.postimg.cc/k5kH3wM4/Screenshot-20260605-083930.jpg', external: true },
  sku_54: { pid: '72', row: 'HIKARI MOD FF ROOT ANDROID', name: 'HIKARI 30 DAY', duration: '30 Days', price: 595, image: 'https://i.postimg.cc/k5kH3wM4/Screenshot-20260605-083930.jpg', external: true },
  ...
  sku_71: { pid: '74', row: 'KOS FF ROOT ANDROID', name: 'KOS ROOT 30 DAY', duration: '30 DaYs', price: 1085, image: 'https://i.postimg.cc/R098B4HF/file-0000000031fc720886d5eb5b766c5d0b.png', external: true },
  sku_72: { pid: '74', row: 'KOS FF ROOT ANDROID', name: 'KOS ROOT 7 DAY', duration: '7 DaYs', price: 385, image: 'https://i.postimg.cc/R098B4HF/file-0000000031fc720886d5eb5b766c5d0b.png', external: true },

  // ---- MIGUL IPHONE IOS FF (pid 69) ----
  sku_73: { pid: '69', row: 'MIGUL IPHONE IOS FF', name: 'MIGUL BASIC 1 DAY', duration: '1 DaYs Basic', price: 280, image: 'https://i.postimg.cc/MHhPrSwQ/file-00000000b7bc7208b6362b0658f64e7e.png', external: true },
  sku_74: { pid: '69', row: 'MIGUL IPHONE IOS FF', name: 'MIGUL PRO 1 DAY', duration: '1 DaYs PRO', price: 385, image: 'https://i.postimg.cc/MHhPrSwQ/file-00000000b7bc7208b6362b0658f64e7e.png', external: true },
  sku_75: { pid: '69', row: 'MIGUL IPHONE IOS FF', name: 'MIGUL BASIC 30 DAY', duration: '30 DaYs Basic', price: 1260, image: 'https://i.postimg.cc/MHhPrSwQ/file-00000000b7bc7208b6362b0658f64e7e.png', external: true },
  sku_76: { pid: '69', row: 'MIGUL IPHONE IOS FF', name: 'MIGUL PRO 30 DAY', duration: '30 DaYs PRO', price: 2240, image: 'https://i.postimg.cc/MHhPrSwQ/file-00000000b7bc7208b6362b0658f64e7e.png', external: true },
  sku_77: { pid: '69', row: 'MIGUL IPHONE IOS FF', name: 'MIGUL BASIC 7 DAY', duration: '7 DaYs Basic', price: 630, image: 'https://i.postimg.cc/MHhPrSwQ/file-00000000b7bc7208b6362b0658f64e7e.png', external: true },
  sku_78: { pid: '69', row: 'MIGUL IPHONE IOS FF', name: 'MIGUL PRO 7 DAY', duration: '7 DaYs PRO', price: 1085, image: 'https://i.postimg.cc/MHhPrSwQ/file-00000000b7bc7208b6362b0658f64e7e.png', external: true },

  // ---- NEO STRIKE FF ROOT ANDROID (pid 70) ----
  sku_79: { pid: '70', row: 'NEO STRIKE FF ROOT ANDROID', name: 'NEO STRIKE 1 DAY', duration: '1 DaYs', price: 84, image: 'https://i.postimg.cc/fbjGtJN9/file-00000000f5b47208b97547f7d5746409.png', external: true },
  sku_80: { pid: '70', row: 'NEO STRIKE FF ROOT ANDROID', name: 'NEO STRIKE 14 DAY', duration: '14 DaYs', price: 455, image: 'https://i.postimg.cc/fbjGtJN9/file-00000000f5b47208b97547f7d5746409.png', external: true },
  sku_81: { pid: '70', row: 'NEO STRIKE FF ROOT ANDROID', name: 'NEO STRIKE 28 DAY', duration: '28 DaYs', price: 595, image: 'https://i.postimg.cc/fbjGtJN9/file-00000000f5b47208b97547f7d5746409.png', external: true },
  sku_82: { pid: '70', row: 'NEO STRIKE FF ROOT ANDROID', name: 'NEO STRIKE 3 DAY', duration: '3 DaYs', price: 210, image: 'https://i.postimg.cc/fbjGtJN9/file-00000000f5b47208b97547f7d5746409.png', external: true },
  sku_83: { pid: '70', row: 'NEO STRIKE FF ROOT ANDROID', name: 'NEO STRIKE 7 DAY', duration: '7 DaYs', price: 350, image: 'https://i.postimg.cc/fbjGtJN9/file-00000000f5b47208b97547f7d5746409.png', external: true },

  // ---- PATO TEAM FF ALL ANDROID (pid 54) ----
  sku_84: { pid: '54', row: 'PATO TEAM FF ALL ANDROID', name: 'PATO MIX 15 DAY', duration: '15 DaYs All Colours Mix', price: 875, image: 'https://i.postimg.cc/RV2ypjJM/Screenshot-20260421-102813.jpg', external: true },
  sku_85: { pid: '54', row: 'PATO TEAM FF ALL ANDROID', name: 'PATO MIX 3 DAY', duration: '3 DaYs All Colours Mix', price: 385, image: 'https://i.postimg.cc/RV2ypjJM/Screenshot-20260421-102813.jpg', external: true },
  sku_86: { pid: '54', row: 'PATO TEAM FF ALL ANDROID', name: 'PATO MIX 30 DAY', duration: '30 DaYs All Colours Mix', price: 1085, image: 'https://i.postimg.cc/RV2ypjJM/Screenshot-20260421-102813.jpg', external: true },
  sku_87: { pid: '54', row: 'PATO TEAM FF ALL ANDROID', name: 'PATO MIX 7 DAY', duration: '7 DaYs All Colours Mix', price: 595, image: 'https://i.postimg.cc/RV2ypjJM/Screenshot-20260421-102813.jpg', external: true },

  // ---- PRIME HOOK FF NONROOT ANDROID (pid 48) ----
  sku_88: { pid: '48', row: 'PRIME HOOK FF NONROOT ANDROID', name: 'PRIME 1 DAY', duration: '1 Days Nonroot', price: 70, image: 'https://i.postimg.cc/x8ChBQPd/IMG-20260421-102934-585.jpg', external: true },
  sku_89: { pid: '48', row: 'PRIME HOOK FF NONROOT ANDROID', name: 'PRIME 10 DAY', duration: '10 Days Nonroot', price: 350, image: 'https://i.postimg.cc/x8ChBQPd/IMG-20260421-102934-585.jpg', external: true },
  sku_90: { pid: '48', row: 'PRIME HOOK FF NONROOT ANDROID', name: 'PRIME 3 DAY', duration: '3 Days Nonroot', price: 112, image: 'https://i.postimg.cc/x8ChBQPd/IMG-20260421-102934-585.jpg', external: true },
  ...
  sku_123: { pid: '66', row: 'XYZ CHEATS FF ROOT ANDROID', name: 'XYZ 3 DAY', duration: '3 Days', price: 98, image: 'https://i.postimg.cc/Y0HwXZkt/IMG-20260430-190421-873.jpg', external: true },
